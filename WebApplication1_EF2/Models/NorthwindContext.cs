...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-520STTO;Database=Northwind;uid=sa; pwd=12345; trustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Kullanicilar>(entity =>
        {
            ...
            entity.Property(e => e.MemleketId)
                .HasMaxLength(20)
                .HasColumnName("memleketID");
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb => tb.HasTrigger("tg_unitsinstockcontrol"));
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("sLog"));
        ...
        modelBuilder.Entity<Tedarikciler>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyName, "NonClusteredIndex-20221213-220111");
